...
--Crear N compras para cada proveedor.  N= �ltimo d�gito de su c�dula jur�dica 
--3 La fecha de la compra ser� a partir del '15/01/2023' + 7*ID_Proveedor 
...
select * from compras
----------------------------------------------------
--Cada COMPRA tendr� M DETALLES_COMPRA. Seg�n sea el �ltimo d�gito de la fecha de compra.  MOD(to_char(fecha,'dd'),3)+3
...
----------------------------------------------------
--Seg�n la CANTIDAD asignada, crear UNIDADES
...
VALUES (101, 'Juan', 'Pérez', 'Direccion 1', 88888888, 'juan.perez@example.com', TO_DATE('1990-01-01', 'YYYY-MM-DD'));
